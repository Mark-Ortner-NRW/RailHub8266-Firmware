...
**Rationale**:
- **Low Cost**: ESP8266 modules cost $2-5 vs. $10-15 for ESP32
...
- Single-core limits concurrency (vs. ESP32 dual-core)
- Fewer GPIO pins (7 usable vs. ESP32's 16+)
...
|-----|----------|-----------|
| ADR-001 | Use ESP8266 instead of ESP32 | Lower cost, sufficient for 7 outputs |
...
| ADR-008 | Chasing groups as ESP8266-exclusive feature | Differentiates from ESP32 version |
