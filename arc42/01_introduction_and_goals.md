...
The firmware is optimized for the ESP8266's memory constraints while delivering unique features like chasing light groups for sequential lighting effects.
...
- **Rationale**: ESP8266 has limited memory requiring careful resource management
- **Measures**:
